<div>
    ...
    <div class="w-auto p-5 border border-gray-100">
        <p class="text-base text-gray-700 font-semibold"> Select date and click button to generate Orbis Custody File</p>
        <form wire:submit.prevent="submit" class="flex flex-col">
            <div class="mr-5">
                <label for="custody-date" class="input-label mt-4">Date</label>
                <input type="date" id="custody-date" class="input" wire:model.lazy="date">
                @error('date') <span class="text-sm text-red-400 italic">{{ $message }}</span> @enderror
            </div>
