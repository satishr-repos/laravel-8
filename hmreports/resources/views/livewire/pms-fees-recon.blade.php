<div>
    ...
    <div class="w-auto p-5 border border-gray-100">
        <p class="text-base text-gray-700 font-semibold"> Select date and click button to generate PMS Fees Report</p>
        <form wire:submit.prevent="submit" class="flex flex-col">
            ...
            <div class="flex">
                ...
                <div>
                    ...
                    <input type="date" id="report-date" class="input" wire:model.lazy="end_date">
