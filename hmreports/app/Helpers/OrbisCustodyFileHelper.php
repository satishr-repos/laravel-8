...
class OrbisCustodyFileHelper
{
    ...
    {
        $template = Storage::path('private/OrbisCustodyFileTemplate.xlsx');
    ...
    public function StoreResults()
    {
        if(count($this->results) < 1)
            throw new Exception("Invalid results from procOrbisCustdyFileGen");
