...
class CorpActnHelper
{
    ...
    {
        $template = Storage::path('private/CorpActnTemplate.xlsx');
    ...
    public function StoreResults()
    {
        if(count($this->results) < 2)
            throw new Exception("Invalid results from procCorpActnNse");
