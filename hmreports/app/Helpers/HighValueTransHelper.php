...
class HighValueTransHelper
{
    ...
    {
        $template = Storage::path('private/HighValueTransTemplate.xlsx');
    ...
    public function StoreResults()
    {
        if(count($this->results) < 1)
            throw new Exception("Invalid results from High Value Transactions");
