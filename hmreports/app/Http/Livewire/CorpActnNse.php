...
class CorpActnNse extends Component
{
    use WithFileUploads;
    ...
    public function mount()
    {
        ...
        $this->inputFile = "NSE_INPUT$y$m$d.csv";
        $this->inputPath = "D:\VIGNESH\CORPORATEACTION\FY_2021-22\NSE";
    }
    ...
    public function submit()
    {
        ...
        try
        {
            $dest = join(DIRECTORY_SEPARATOR, array($this->inputPath, $this->inputFile));
            if(!file_exists($dest))
                throw new Exception("NSE_INPUT file not found. Upload the file to proceed");

            $pdo = DB::connection("sqlsrv")->getPdo();
            $pdo->setAttribute(\PDO::ATTR_EMULATE_PREPARES, true);
            $syntax = "set nocount on;exec dbo.procCorpActnNSE @FolderPath='1'";
    ...
    {
        return view('livewire.corp-actn-nse');
    }
}
