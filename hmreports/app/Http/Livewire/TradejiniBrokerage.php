...
use App\Helpers\TradejiniBrokerageHelper;
use Livewire\WithFileUploads;
use Livewire\Component;
use Exception;
use File;

class TradejiniBrokerage extends Component
{
    use WithFileUploads;
    ...
    public function mount()
    {
        ...
        $this->inputFile = "Trade.csv";
        $this->inputPath = "E:\Trade_Files";
    }
    ...
    public function submit()
    {
        ...
        try
        {
            $dest = join(DIRECTORY_SEPARATOR, array($this->inputPath, $this->inputFile));
            if(!file_exists($dest))
                throw new Exception("Trade.csv file not found. Upload the file to proceed");

            $pdo = DB::connection("sqlsrv")->getPdo();
            $pdo->setAttribute(\PDO::ATTR_EMULATE_PREPARES, true);
            $syntax = "set nocount on;exec dbo.procLoadTradeJiniBrokerFile;";
            ...
            $helper = new TradejiniBrokerageHelper($results);
    ...
    {
        return view('livewire.tradejini-brokerage');
    }
}
