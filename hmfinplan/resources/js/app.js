...
const app = new Vue({
    ...
    components: {
        ...
        RealEstate: () => import('./components/Asset/RealEstate.vue'),
        PersonalAsset: () => import('./components/Asset/PersonalAsset.vue'),
        BankAsset: () => import('./components/Asset/BankAsset.vue'),
        FixedAsset: () => import('./components/Asset/FixedAsset.vue'),
        InvestmentAsset: () => import('./components/Asset/InvestmentAsset.vue'),
        RetirementAsset: () => import('./components/Asset/RetirementAsset.vue'),
