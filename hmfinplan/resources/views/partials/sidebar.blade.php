{{-- <div class="h-full w-auto"> --}}
    <div class="fixed flex flex-col top-0 left-0 max-w-none h-full w-auto bg-white border-r" id="sidebar">
      ...
      <div class="overflow-y-auto overflow-x-hidden flex-grow">
        <ul class="flex flex-col py-4 space-y-1">
          ...
          <li>
            <a id="assets" class="relative flex flex-row items-center h-11 cursor-default focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800  hover:shadow-md pr-6">
              <span class="inline-flex justify-center items-center ml-4">
              ...
              <span class="ml-2 text-sm tracking-wide truncate inline-flex items-center">Assets
                <svg id="clickimg" fill="currentColor" viewBox="0 0 20 20" class="inline w-5 h-5 mt-0 ml-1 transition-transform duration-200 transform rotate-0"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
              </span>
            </a>
          </li>
          <li id="tangible" class="hidden">
          ...
          <li>
            <a href="{{ route('customer.finplan', $customer) }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-r-4 {{ $current == 'Financial Plan'? 'border-red-500' : 'border-transparent'}} hover:shadow-md hover:border-indigo-500 pr-6">
              <span class="inline-flex justify-center items-center ml-4">
