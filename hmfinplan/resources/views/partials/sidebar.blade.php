    ...
    <div class="fixed flex flex-col top-0 left-0 max-w-max bg-white h-full border-r">
      ...
      <div class="overflow-y-auto overflow-x-hidden flex-grow">
        <ul class="flex flex-col py-4 space-y-1">
          ...
          <li>
            <a href="{{ route('customer.dashboard', $customer)}}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 hover:shadow-md text-gray-600 hover:text-gray-800 
            {{ $current == 'dashboard'? 'border-r-4 border-red-500' : 'border-l-4 border-transparent'}} hover:border-indigo-500 pr-6">
          ...
          <li>
            <a href="{{ route('customer.personal', $customer) }}" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 hover:shadow-md text-gray-600 hover:text-gray-800 {{ $current == 'personal'? 'border-r-4 border-red-500' : 'border-l-4 border-transparent'}} hover:border-indigo-500 pr-6">
              <span class="inline-flex justify-center items-center ml-4">
          ...
          <li>
            <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:shadow-md hover:border-indigo-500 pr-6">
              ...
              <span class="ml-2 text-sm tracking-wide truncate">Income Sources</span>
            </a>
          </li>
          <li>
            <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:shadow-md hover:border-indigo-500 pr-6">
              ...
              <span class="ml-2 text-sm tracking-wide truncate">Insurance Policies</span>
          ...
          <li>
            <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:shadow-md hover:border-indigo-500 pr-6">
              ...
              <span class="ml-2 text-sm tracking-wide truncate">Assumptions</span>
            </a>
          </li>
        </ul>
      </div>
